...
if __name__ == '__main__':
    ...
    type = TypesOfSpells(name_of_type="Charm", file="db/assets/charms_il.jpg")
    session.add(type)
    type = TypesOfSpells(name_of_type="Transfiguration", file='db/assets/transfiguration_il.jpg')
    session.add(type)
    type = TypesOfSpells(name_of_type="DarkCharm", file='db/assets/DarkCharm_il.jpg')
    session.add(type)
    type = TypesOfSpells(name_of_type="Curse", file='db/assets/curse_il.jpg')
    session.add(type)
    type = TypesOfSpells(name_of_type="BindingMagicalContract", file='db/assets/BindingMagicalContract_il.jpg')
    session.add(type)
    type = TypesOfSpells(name_of_type="Vanishment", file='db/assets/Vanishment_il.jpg')
    session.add(type)
    session.commit()